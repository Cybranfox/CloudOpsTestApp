/**
 * Enhanced ZapAnimator for Cloud Orbit - Slay the Spire Edition v2
 * 
 ...
 * Enhanced with image swapping for different poses
 */

// Image mapping for different poses
const ZAP_IMAGES = {
  idle: '/static/mascot/zap_idle.png',
  victory: '/static/mascot/zap_victory.png',
  defeat: '/static/mascot/zap_defeat.png',
  curious: '/static/mascot/zap_curious.png',
  explaining: '/static/mascot/zap_explaining.png',
  sleeping: '/static/mascot/zap_sleeping.png',
  levelup: '/static/mascot/zap_levelup.png',
  shopping: '/static/mascot/zap_shopping.png',
  // Map additional states to existing images as fallbacks
  battle_ready: '/static/mascot/zap_curious.png',
  elite_victory: '/static/mascot/zap_victory.png',
  boss_victory: '/static/mascot/zap_victory.png',
  boss_encounter: '/static/mascot/zap_curious.png',
  hint: '/static/mascot/zap_explaining.png',
  streak_celebration: '/static/mascot/zap_levelup.png',
  loot_found: '/static/mascot/zap_victory.png',
  resting: '/static/mascot/zap_sleeping.png',
  confused: '/static/mascot/zap_defeat.png'
};
...
export default class EnhancedZapAnimator {
  ...
  /**
   * Play an animation state with enhanced mobile optimization and image swapping
  ...
  play(stateName, options = {}) {
    ...
    // Swap mascot image based on state
    if (ZAP_IMAGES[stateName]) {
      this.mascot.src = ZAP_IMAGES[stateName];
    } else {
      // Fallback to idle image
      this.mascot.src = ZAP_IMAGES['idle'];
    }
